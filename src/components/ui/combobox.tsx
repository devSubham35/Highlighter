  ...
  return (
    <Popover.Root open={open} onOpenChange={handleOpenChange}>
      <Popover.Trigger
        ...
        aria-label={ariaLabel}
        className={cn(
          "flex h-11 w-full min-w-40 items-center justify-between gap-2 rounded-lg border border-input bg-card px-3 text-sm font-medium whitespace-nowrap transition-colors outline-none select-none",
