...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center cursor-pointer justify-center border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground [a]:hover:bg-primary/80 inline-flex items-center justify-center gap-2 font-semibold text-sm leading-[20px] transition-all duration-300 ease-[var(--transition-fn)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--content-primary)] cursor-pointer select-none whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden h-[var(--large-input-height)] px-[1.125rem] py-3 rounded-[var(--button-border-radius-lg)] bg-[var(--button-brand-bg)] text-[var(--button-brand-color)] hover:bg-[var(--button-brand-hover-bg)] shadow-[0_1px_2px_0_rgba(0,0,0,0.05),inset_0_1px_3px_0_rgba(255,255,255,0.32),inset_0_0_0_1px_rgba(255,255,255,0.12)] bg-primary',
        outline:
          '!border-border bg-background hover:bg-muted dark:hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50 hover:bg-gray-100 text-primary dark:text-white hover:text-[var(--button-brand-hover-bg)]',
        secondary:
